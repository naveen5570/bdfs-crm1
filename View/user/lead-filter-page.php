...
?>
        ...
        <div class="row">
           <div class="leadpage" style="overflow-x:scroll;">
             ...
             <form action="http://bdforsale.com/user/sendFilterCampaign" method="post" id="myform" >
...
<td class="sorting_1"><input type="checkbox" name="checkedleads[]" class="leads_checkbox" value="<?= $data->ceo_email ?>"></td>
                                ...
                                <td><?=$assignto;?></td>
                                <td><a href="<?=BASEURL;?>user/viewLead/<?=$data->id;?>" target="_blank"><?=$data->firm_name?></a></td><td><?=$data->firm_crd;?></td>
                                <td><?=$data->ceo_name;?></td>
