...
<div id="page-content-wrapper">
    <div class="container-fluid">
        <div class="profile breadcrumbs" style="padding:5px 10px; font-size:12px">
			<a href="<?=BASEURL?>">Home</a> >> <a href="<?=BASEURL?>user/leads">All Leads</a> >> <a href="<?=BASEURL?>user/lead/<?=$leadst[0]->name;?>"><?=$leadst[0]->name;?></a> >> <?=$leadsub[0]->name; ?>
			</div>
                ...
                <div class="col-md-6">
                    <?php
                        ...
                        foreach ($leadsubstatus as $key => $value) {
                            ...
                            echo '<p style="margin-bottom: 0.5em;"><a href="'.BASEURL.'user/leadsubstatus/'.$lead_typename.'/'.str_replace(" ","_",$leadcurrentstatus).'/'.str_replace(" ","_",$value->name).'" class="label" style="font-size: 97%;background-color: '.$labelbtnbgcolor[$key].'">'.$value->name.' : '.$leadcount[$key].' leads </a></p>';
