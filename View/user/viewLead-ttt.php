...
<script>
                            ...
                            <style>
                            .status_popup {position:fixed; transform:translate(-50%,-50%); top:50%; left:50%; width:600px; z-index:9999; background:#00c6d7; padding:50px 60px; border-radius:8px; display:none; }
							.status_button_nav {cursor:pointer}
							.close_status {position:absolute; right:-8px; font-weight:bold; top:-12px; cursor:pointer; border-radius:50%; padding:4px 10px; background:#000; color:#fff;}
