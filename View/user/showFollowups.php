...
<div id="page-content-wrapper">
   ...
   ?>         
                            <tr class="gc_row row<?=$prev->id;?>">
                                ...
                                <td><?=$prev->msg;?></td>
                                <td><?= date('m-d-y', $prev->reminder_date); ?></td>
                                <td><?= date('m-d-y', $prev->date); ?>
                                </td>
   ...
   ?>         
                            <tr class="gc_row row<?=$today->id;?>">
                                ...
                                <td><?= date('m-d-y', $today->date); ?>
                                </td>
                                <td><?php if ($today->status == 0) {
                                                    echo "Pending";
                                                } else {
                                                    echo "Completed";
                                                } ?></td>
