...
<head>
    ...
    <link href="<?=BASEURL;?>assets/administrator/css/main.css" rel="stylesheet">
</head>
<body>
    ...
    <div class="col-md-4">
        ...
        <div class="login-form">
            <form action="<?=BASEURL;?>administrator/adminSingIn" method="post">    
            ...
            <p>Forgot Your Password <a data-toggle="modal" href="#forgot">Click here</a></p>		
        </div>
    </div>
    <div class="col-md-4"></div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Enter Your eamil ID</h4>
      </div>
      <div class="my-mod modal-body">
        <form action="">
            <div class="form-group">
