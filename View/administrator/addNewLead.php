...
<div id="page-content-wrapper">
    <div class="container-fluid">
        <div class="leadfrm">
            <form action="<?=BASEURL;?>administrator/addlead"  class="leadstsfrm" method="post">
                <div class="creoption">
                    <h1 class="headtit">Create Lead</h1>
                    <a class="btn1" href = '<?=BASEURL?>/administrator/leads'>Cancel</a>
                    ...
                    <div class="row">
                       <div class="form-group col-md-6 col-sm-6">
                            ...
                            <select name="leadfrom" class="form-control leadtypeselect" >
                                ...
                                ?>
                                    <option value="<?=$leadstypes->id;?>" style="background:beige"><?=ucwords($leadstypes->name);?>=>(<?=ucwords($leadstypes->description);?>)</option>
                                <?php }?>
                            </select>
                        </div>
                        <div class="form-group col-md-6 col-sm-6">
                        ...
                        <div class="form-group col-md-6 col-sm-6">
                            ...
                            <select name="lead_substatus" class="form-control leadsubstatusbystatus">
                               ...
                               <?php
                                ...
                                ?>
                                <option value="<?=$leadsubstatus->id;?>"  <?php if($data->lead_substatus_id == $leadsubstatus->id){echo 'selected';}?>style="word-wrap:pre"><?=$leadsubstatus->name;?>=>(<?=ucwords($leadsubstatus->description);?>)</option>
                                <?php }?>
                            </select>
                        </div>
                        <div class="form-group col-md-6 col-sm-6">
                            ...
                            <select name="lead_subsubstatus" class="form-control leadsubsubstatusbysubstatus">
                               ...
                               <?php
                                ...
                                ?>
                                <option value="<?=$leadsubsubstatus->id;?>" <?php if($data->lead_subsubstatus_id == $leadsubsubstatus->id){echo 'selected';}?>style="word-break: break-all"><?=$leadsubsubstatus->name;?>=>(<?=ucwords($leadsubsubstatus->description);?>)</option>
                                <?php }?>
                            </select>
                        </div>
                        <?php /* ?>
