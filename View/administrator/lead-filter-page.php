...
<?php */ ?>
                  <div class="form-group col-sm-6 leadstsfrm">
                    <label for="inputEmail3" class="col-sm-12 control-label">Lead From</label>
                    <div class="col-sm-12">
                      <select name="leadfrom" class="form-control leadtypeselect">
                          ...
                          ?>
                              <option value="<?=$leadstypes->id;?>"
                                <?php if(isset($lead_from)){
                                  if($lead_from == $leadstypes->id){
                                    echo " selected ";
                                  }
                                }
                               ?>
				  ...
				  <div class="form-group col-sm-6">
                    <label for="inputEmail3" class="col-sm-12 control-label">Lead Status</label>
                    <div class="col-sm-12">
                      <select name="lead_status" class="form-control leadstatusbytype">
                          <option value="">-- Choose Status --</option>
                          <?php 
                                    //$leadstatus = Leadstatu::all(['lead_type_id'=>1]);
									$leadstatus = Leadstatu::all();
									$leadfrom = Leadstype::all();
                                    if(count($leadstatus) > 0){
                                        foreach($leadstatus as $status){
                                    ?>
                                        <option value="<?=$status->id;?>"
                  ...
                  <div class="form-group col-sm-12">
                  <label  class="col-sm-12 control-label">Rom Branch Count</label>
                  <div class="col-sm-4">
                  <?php /* ?>
...
<?php 
foreach($leadfrom as $from){
if($lead_from==$from->id)
{
echo 'Selected Lead Type is "'. $from->name.'"';	
}
}
?>
...
<div class="col-md-8" style="padding-left:5px;">
<div class="tags_nav" style="background:#096;">
<?php 
foreach($leadstatus as $status){
if($lead_status==$status->id)
{
echo 'Selected Lead Status is "'. $status->name.'"';	
}
}
?>
