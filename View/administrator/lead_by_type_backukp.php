                ...
                <div class="col-md-6">
                    <?php
                        ...
                        foreach( $leadstatus as $leadst){
                            ...
                            $color = rendomColor()[$i];
                            $labcolor .= ' "'.$color.'",';
                            $leadcounts = Lead::find_by_sql("select COUNT(*) as leadcount from leads where leadfrom = $lead_type and lead_status_id = ".$leadst->id);
                        ...
                        foreach ($leadstatus as $key => $value) {
                            ...
                            echo '<p style="margin-bottom: 0.5em;"><a href="'.BASEURL.'administrator/leadstatus/'.$lead_typename.'/'.str_replace(" ","_",$value->name).'" class="label" style="font-size: 97%;background-color: '.$labelbtnbgcolor[$key].'">'.$value->name.' : '.$leadcount[$key].' leads </a></p>';
                        }
                        $labels = rtrim($labels,",");
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row form-group">
                    ...
                    <div class="col-md-6">
        					    <select class="form-control assignleadsuser" data-id="<?=$data->id;?>">
...
$('.leads_by_type_datatable').DataTable({
    ...
    lengthMenu: [[10, 25, 50, 100, 500, 1000, 2000, 3000, 10000], [10, 25, 50, 100, 500, 1000, 2000, 3000, 'All']],
        buttons : [ {
            ...
            title : 'Leads',
            exportOptions : {
columns: [3,4,5,6,20,21,24,25,26,27,28],
                modifier : {
