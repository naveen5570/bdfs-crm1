    ...
    <div class="container-fluid">
        <div class="notypnl">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="#panding" aria-controls="panding" role="tab" data-toggle="tab">Accepted</a></li>
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="activetb">
                    <table class="table table-striped alldatatbl1">
                        <thead>
                            <tr>
                                <th>S.No</th>
                                <th>Lead</th>
          ...
          $lead = Lead::all(['id'=>$data->leadid]);
                ...
                <tr class="gc_row row<?=$data->id;?>">
                    ...
                    <td><?=$data->comments;?></td>
                    <td><a class="btn btn-info" href="<?=BASEURL?>administrator/acceptRequest/<?=$data->id;?>">Accept</a><a class="btn btn-danger" href="<?=BASEURL?>administrator/rejectRequest/<?=$data->id;?>">Reject</a></td>
