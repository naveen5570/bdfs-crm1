...
foreach($leadsfist as $leadsfist1)
{//echo '<pre>'.$leadsfist1->id.'</pre>';
	}
                        ...
                        <a href="<?=BASEURL;?>administrator/viewLead/<?=$leadsnext[0]->id;?><?php if($type != null || $type != ''){echo '/'.$data->leadfrom; } ?><?php if($leadcurrentstatus != null || $leadcurrentstatus != ''){echo '/'.$leadcurrentstatus; } ?><?php if($leadcurrentsubstatus != null || $leadcurrentsubstatus != ''){echo '/'.$leadcurrentsubstatus; } ?>"><i class="fa fa-angle-right"></i></a></li>
                        <?php } ?>
                      </div>
                      <ul class="viewldlst">
                       ...
                       <li>
                        ...
                        <select class="substatuschange" data-id="<?=$data->id;?>" >
                            <?php

                                foreach ($leadsubstatus as $leadsubstatus){
                            ?>
                            <option <?php if($data->lead_substatus_id == $leadsubstatus->id ){echo 'selected';}?> value="<?=$leadsubstatus->id;?>"> <?=$leadsubstatus->name;?></option>
                            <?php }?>
                        </select>
...
<li><a href="javascript:;" data-toggle="modal" data-target="#actionDate"><i class="fa fa-calendar-plus-o"></i></a></li>
            ...
            <div class="leadinfo">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <!-- <?php
                            $industries = Industry::all(['id' => $data->industry_id]);
            ...
            <div class="leadinfo">
                ...
                <div class="row">
					...
					$bus = explode(',', $data->business_lines);
					foreach ($bus as $business)
					{
					$content = Businessline::all(['id'=>$business]);
					echo $content[0]->name.'<br>';
					}
					?></div>
                </div>
            </div>
