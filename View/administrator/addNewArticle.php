...
<div id="page-content-wrapper">
    <div class="container-fluid">
        <div class="leadfrm">
            <form action="<?=BASEURL;?>administrator/addArticle"  class="leadstsfrm" method="post">
                <div class="creoption">
                ...
                <div class="myform">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12 col-sm-12">
                            ...
                            <input type="text" class="form-control" name="name" placeholder="Enter Article Name" required>
                        </div>
                        <div class="form-group col-md-12 col-sm-12">
                              ...
                              <?php
                               ...
                               ?>
                                     <tr>
                                         ...
                                         <td><Input type="checkbox" name="leadids[]" class="leads_checkbox" value=<?=$data->id;?>></td>
