...
<div id="page-content-wrapper">
    <div class="container-fluid">
        ...
        <h3 style="text-align:center; color:green; padding-bottom:15px;">
        <?php
            if (isset($_GET['msg'])) {
                echo $_GET['msg'];
            }
        ?></h3>
        <div class="modal_nav"><span class="close_nav">x</span>
            <div id="ccc"></div>
        </div>
        <?php
        if ($emails != '') {
        ...
        ?>
        <form role="form" id="formfield" class="myform" method="post" action="<?= BASEURL; ?>administrator/sendCLeadFilterCampaign">
         ...
         <input class="form-control" type="text" name="receiver_email" required placeholder="Receiver's Email">
          ...
          <textarea name="email_body"></textarea>
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" name="email_body" placeholder="Email Body"></textarea>
        ...
        $('#status').on('change', function() {
            ...
            if (status) {
                $.ajax({
                    ...
                    beforeSend: function() {
                        $('.processing_nav').css('display', 'block')
                    },
                    data: {
                        "status": status,
                        "type": type
