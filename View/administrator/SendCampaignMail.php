...
$arr = [];
error_reporting(0);
$max_crd = Lead::find_by_sql('SELECT MAX(`firm_crd`) as minimum FROM `cleads`');
...
<div id="page-content-wrapper">
    <div class="container-fluid">
                    ...
                    <form class="" method="post" action="<?= BASEURL; ?>administrator/showFilterLeads">
                        ...
                        <div class="form-group col-md-8" style="margin-bottom:40px;">
                            ...
                            <select name="query_type" class="form-control">
                                <option value="or" <?php if (isset($query)) {
                                                        if ($query == 'or') {
                                                            echo 'selected';
                                                        }
                                                    } ?>>OR</option>
                                <option value="and" <?php if (isset($query)) {
                                                        if ($query == 'and') {
                                                            echo 'selected';
                                                        }
                                                    } ?>>AND</option>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6">
                                <div class="">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="business_lines[]" <?php
                        ...
                        <div class="form-group col-sm-4 leadstsfrm">
                          ...
                          ?>
                                    <option value="<?=$leadstypes->id;?>" <?php if(isset($leadfrom)){
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <div class="col-sm-7">
                                <select name="lead_status" class="form-control leadstatusbytype">
                                    ...
                                    ?>
                                    <option value="<?=$status->id;?>" <?php if(isset($lead_status)){
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-4">
                                ...
                                <select name="rom_branch_counts" class="form-control leadstatusbytype">
                                    ...
                                    <option value="< 5" <?php if($rom_branch_count=="< 5"){ echo "selected"; } ?>>Less
                                        than 5</option>
                                    <option value="BETWEEN 5 AND 10"
                                        <?php if($rom_branch_count=="BETWEEN 5 AND 10"){ echo "selected"; } ?>>Between 5
                                        and 10</option>
                                    <option value="BETWEEN 10 AND 15"
                                        <?php if($rom_branch_count=="BETWEEN 10 AND 15"){ echo "selected"; } ?>>Between
                                        10 and 15</option>
                                    <option value="BETWEEN 15 AND 20"
                                        <?php if($rom_branch_count=="BETWEEN 15 AND 20"){ echo "selected"; } ?>>Between
                                        15 and 20</option>
                                    <option value="BETWEEN 20 AND 25"
                                        <?php if($rom_branch_count=="BETWEEN 20 AND 25"){ echo "selected"; } ?>>Between
                                        20 and 25</option>
                                    <option value="BETWEEN 25 AND 30"
                                        <?php if($rom_branch_count=="BETWEEN 25 AND 30"){ echo "selected"; } ?>>Between
                                        25 and 30</option>
                                    <option value="> 30" <?php if($rom_branch_count=="> 30"){ echo "selected"; } ?>>30
                                        and above</option>
                                </select>
                                <?php */ ?>
                                <select name="value_type" class="form-control value_type">
                                    <option value="single" <?php if ($value_type == 'single') {
                                                                echo "selected";
                                                            } ?>>Single Value</option>
                                    <option value="range" <?php if ($value_type == 'range') {
                                                                echo "selected";
                                                            } ?>>Range</option>
                                </select>
                            </div>
                            <div class="col-md-2">
                                <input type="text" name="value1" class="form-control" placeholder="value"
                                    required="required"
                                    value="<?php if (isset($value1)) {
                                                                                                                                            echo $value1;
                                                                                                                                        } ?>" />
                            </div>
                            <div class="col-md-2">
                                <input type="text" name="value2" class="form-control value2" placeholder="value"
                                    value="<?php if (isset($value2)) {
                                                                                                                            echo $value2;
                                                                                                                        } ?>" />
                            </div>
                        </div>
                        <div class="form-group col-sm-6">
                            <div class="col-sm-offset-3 col-sm-9">
                                ...
                                <a href="<?= BASEURL; ?>administrator/leadFiltaration" class="btn btn-danger">Reset
                                    Filter</a>
                            </div>
                        </div>
                    </form>
        ...
        <div class="row">
            <div class="leadpage" style="overflow-x:scroll;">
                <div class="counts_nav1" style="text-align:center;"><?php echo $_GET['msg'] ?></div>
                <div class="counts_nav"></div>
                <div class="col-md-12 col-sm-12">
                    <form action="<?= BASEURL; ?>/administrator/sendCFilterCampaign" method="post"
                        id="myform">
                ...
                $sql = "SELECT leads.firm_crd, leads.ceo_email,leads.id,leads.ceo_name, leads.firm_name, leads.user_id, cleads.emailstatus 
                FROM cleads
                INNER JOIN leads ON leads.firm_crd = cleads.firm_crd";

            // $sql = "SELECT leads.firm_crd, leads.ceo_email, leads.id,leads.ceo_name, leads.firm_name, leads.user_id, cleads.emailstatus, subadmins.name
            // FROM ((cleads
            // INNER JOIN leads ON leads.firm_crd = cleads.firm_crd)
            // INNER JOIN subadmins ON leads.user_id = subadmins.id)"; 
            ...
            <table id="example" class="table table-striped table-bordered display responsive nowrap" cellspacing="0" style="width:100%">
                <thead>
                    <tr>
                    <th>
                                    <div class="btn-group">
                                        <button type="button" data-toggle="dropdown"
                                            class="btn btn-delete dropdown-toggle"><i class="fa fa-square-o"
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                        <td class="sorting_1"><input type="checkbox" name="checkedleads[]"
                                        class="leads_checkbox" value="<?= $row['ceo_email'] ?>"></td>
                            <td><?= $row['id']; ?></td>
                            <td><?= $row['user_id']; ?></td>
                            <td><a href="<?= BASEURL; ?>administrator/viewLead/<?= $row['id']; ?>"
                                        target="_blank"><?= $row['firm_name']; ?></a></td>
                            <td><?= $row['firm_crd']; ?></td>
                            <td><?= $row['ceo_name']; ?></td>
                            <td><?=$row['ceo_email']; ?></td>
                            
                            <?php if ($row['emailstatus']==1) { ?>
                            <td style="background-color:sandybrown"><?=  "Completed"; ?></td>
                            <?php } else { ?>
                            <td style="background-color:lightcoral"><?="Pending"; ?></td>
                            <?php } ?>
                    ...
                    <table class="table table-striped alldatatbl" id="example" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="sorting_1"><input type="checkbox" name="checkedleads[]"
                                        class="leads_checkbox" value="<?= $data->ceo_email ?>"></td>
                                <td>#<?= sprintf('%04d', $data->id); ?></td>
                                <td><?= $assignto; ?></td>
                                <td><a href="<?= BASEURL; ?>administrator/viewLead/<?= $data->id; ?>"
                                        target="_blank"><?= $data->firm_name ?></a></td>
                                <td><?= $data->firm_crd; ?></td>
                                <td><?= $data->ceo_name; ?></td>
                                <td><?= Leadstype::find($data->leadfrom)->name; ?></td>
                                <td><?= Leadstatu::find($data->lead_status_id)->name; ?></td>
                                <td><?php
                                            if (isset($data->lead_substatus_id) && $data->lead_substatus_id != 0) {
                                                echo Leadsubstatu::find($data->lead_substatus_id)->name;
                                            }
                                            ?></td>
                                <td><?php
                                            if (isset($data->lead_subsubstatus_id) && $data->lead_subsubstatus_id != '') {
                                                echo Leadsubsubstatu::find($data->lead_subsubstatus_id)->name;
                                            }

                                            ?></td>
                                <td><?php
                                            if (isset($data->ceo_email) && $data->ceo_email != '') {
                                                echo $data->ceo_email;
                                            }
                                            ?></td>
                                <td><?= $data->phone; ?></td>
                                <td><?= str_replace(',', ';', $data->industry_id); ?></td>
                                <td><?= $data->rom_branch_count; ?></td>
...
$(document).ready(function(e) {
    ...
    $('.fff').click(function() {
        ...
        $('#myform').submit(function() {
            $('<input />').attr('type', 'hidden').attr('name', 'emails[]').attr('value',
                leadsid).appendTo('#myform');
        });
    });
        ...
        initComplete: function () {
            this.api().columns('.tt').every( function () {
                ...
                column.unique().sort().each( function () {
                    select.append( '<option value="Pending">Pending</option><option value="Completed">Completed</option>' )
                } );
            } );
        }
...
/* Element | http://localhost/bdfsmailtest/administrator/SendCampaignMail */

div.dataTables_wrapper:nth-child(4) {
  display: none;
}
