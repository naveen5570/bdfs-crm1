...
<div id="page-content-wrapper">
    <div class="container-fluid">
        <div class="profile">
           <h1><img src="<?=BASEURL;?>uploads/images/<?=$users->photo;?> " alt=""> Mr. <?=ucwords($users->name);?> <span>Send Mail</span></h1>
            <div class="row">
                <div class="col-md-6">
                    <h2><span>Email</span> <?=$users->email;?></h2>
                    <h2><span>Mobile</span> <?=$users->mobile;?></h2>
                    <h2><span>Address</span> <?=$users->address;?></h2>
                    <h2><span>City</span> <?=$users->city;?></h2>
                    <h2><span>States</span> <?=$users->states;?></h2>
                </div>
                <div class="col-md-6">
        ...
        <table class="table table-striped alldatatbl">
            ...
            <tbody>
               <?php
                    $i = 1;
                 $leads = Lead::all(['user_id' => $users->id]);
...
<script>
 new Chart(document.getElementById("pie-chart"), {
    ...
    options: {
      title: {
        display: true,
        text: 'All Leads status assign to  <?=$users->name;?>'
      }
    }
});
</script>
