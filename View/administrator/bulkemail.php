          ...
          <td class="container-cell">
            ...
            <table class="c1766">
              <tr>
                ...
                <td class="cell c1776">
                  <div class="c1144">GrapesJS Newsletter Builder |F_NAME|
                    <br/>
                  </div>
                </td>
              </tr>
...
<form id="reload_nav" style="float:left;">
<input type="submit" value="Save Changes"/>
</form>

<a href="#" id="ppp">Name This Template</a>

<form id="popup_form" action="<?=BASEURL;?>administrator/savenewsletter" method="post" style="float:right">
<span>X</span>
...
$('#popup_form span').click(function(){
$('#popup_form').fadeOut();	
});
